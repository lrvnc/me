...
export const logoMap: { [key: string]: { src: string; className?: string } } = {
  'UFSCAR': { src: '/cv/logos/UFSCar.svg', className: 'h-16' },
  'ESPCI Paris': { src: '/cv/logos/espci.png', className: 'h-20' },
  'MIT': { src: '/cv/logos/mit.svg', className: 'h-14' },
  'University of Exeter': { src: '/cv/logos/uoe.png', className: 'h-24' },
  'University of Queensland': { src: '/cv/logos/UQlogo.png', className: 'h-20' },
};

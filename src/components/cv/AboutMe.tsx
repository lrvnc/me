...
const aboutMeImages = [
  { src: '/cv/imgs/mit1-zoom.jpg', alt: 'Me at MIT - 2023' },
  { src: '/cv/imgs/espci2-zoom.jpg', alt: 'My graduation at ESPCI - 2025' },
  { src: '/cv/imgs/espci3.jpg', alt: 'My graduation at ESPCI - 2025' },
  { src: '/cv/imgs/trip1.jpg', alt: 'Trip in UK - 2025' },
];

...
const developmentData = [
  {
    ...
    description: "Speaker at React Conf 2024 on 'State Management in Micro-Frontends'.",
    icon: Rocket,
    tags: ["React", "Public Speaking", "Micro-Frontends"]
  },
  {
    title: "Open Source Contributor",
    description: "Active contributor to the `tRPC` library, focusing on documentation and type safety.",
    icon: Users,
    tags: ["tRPC", "TypeScript", "OSS"]
  },
  {
    title: "Advanced TypeScript Course",
    description: "Completed 'Mastering TypeScript' on Frontend Masters, deepening expertise in advanced types.",
    icon: BookCopy,
    tags: ["TypeScript", "Online Course", "Frontend Masters"]
  },
  {
    title: "Internal Tech Talks",
    description: "Regularly host internal workshops on topics like 'Effective CI/CD Pipelines' and 'GraphQL Best Practices'.",
    icon: Award,
...
const ProfessionalDevelopment = () => (
  ...
  >
    <div className="container mx-auto px-4">
      <h2 className="text-3xl font-bold text-center mb-12 text-gray-900">Professional Development</h2>
      <motion.div
      ...
      >
        {developmentData.map((item) => (
          <motion.div key={item.title} variants={itemVariant} className="h-full">
